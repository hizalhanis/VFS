...
<div class="lcms-plexcart-info">
	<div class="lcms-plexcart-user-info">
		...
		<?php if ($_SESSION['session']): ?>
			...
			<p class="lcms-plexcart-user">Logged in as <?php echo $user->contact_person; ?>. Member points <strong><?php echo number_format($user->points); ?></strong>.</p>
		...
		<?php else: ?>
			...
			<form method="post" action="<?php echo $current_page; ?>login_do">
				<label for="username"><span>Username</span><input type="text" name="username" id="username" /></label>
	...
	<div class="lcms-plexcart-cart-info">
		...
		<span class="lcms-plexcart-cart-total">Total <strong>RM<?php echo $total; ?></strong>.</span>
