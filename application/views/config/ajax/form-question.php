...
function formSubmitted(logic, no){
	no = 0;
	$.ajax({
...
$(document).ready(function(){
	...
	$('button.single-answer-remove').on('click',function(e){
		e.preventDefault();
	...
	$('button.matrix-answer-remove').on('click',function(e){
		e.preventDefault();
	...
	<form method="post" action="<?php echo base_url(); ?>config/ajax/update_question" target="update-frame">
		<table class="">
			<tr>
				<td>Question Type</td>
				<td><?php echo form_dropdown('type', array('single-answer'=>'Multiple Choice, Single Answer', 'multiple-answer'=>'Multiple Choice, Multiple Answer', 'matrix-choice'=>'Matrix of Choices', 'matrix-choice-ma'=>'Matrix of Choices, Multiple Answer', 'matrix-answer'=> 'Matrix of Custom Answer','section'=>'Section'),$type,'class="type" style="width: 250px"'); ?></td>
			</tr>
			<tr>
				<td>Map Data To</td>
				<td><?php echo form_dropdown('map_to', $map_to_array, $map_to, 'style="width: 250px"'); ?></td>
			</tr>
			<tr>
				<td>Appear in Questionnaire</td>
				<td><?php echo form_dropdown('display',array(1=>'Yes',0=>'No'), $display, ' style="width: 250px"'); ?></td>
			</tr>
			<tr>
				<td>Data Type</td>
				<td><?php echo form_dropdown('data_type', array(''=>'Normal Field','time'=>'Time Field','date'=>'Date Field','age'=>'Age Field'), $data_type, ' style="width: 250px"'); ?></td>
			</tr>
		</table>
