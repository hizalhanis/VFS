	...
	<div id="container">
		...
		<div id="nav">
			<ul>
				...
				<li><a <?php if ($this->uri->segment(1) == 'analytics') echo 'class="current"'; ?> href="analytics/process">Data Analysis</a></li>
                ...
                <li>Logged in as <strong><?php echo $this->user->data('username'); ?></strong> <button onclick="location.href='logout'">Logout</button>
			</ul>
		</div>
		<div id="main">
