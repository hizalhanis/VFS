	...
	<form method="post" action="<?php echo $current_page; ?>checkout_do">
	    ...
	    <input type="submit" class="lcms-btn lcms-plexcart-checkout-commit-btn" value="Proceed to Payment" /> <a href="<?php echo $current_page; ?>cart">Back</a>
