...
(function() {
    ...
    function Nd(a, b) {
        function c(p) {
            ...
            function x(k, n, t, r) {
                ...
                this.stack = r;
                this.alignOptions = {
                    align: k.align || (va ? n ? "left" : "right" : "center"),
                    verticalAlign: k.verticalAlign ||
                    (va ? "middle" : n ? "bottom" : "top"),
                    y: A(k.y, va ? 4 : n ? 14 : - 6),
                    x: A(k.x, va ? n?-6 : 6 : 0)
                };
            ...
            function V() {
                ...
                u(Ha, function(r) {
                    ...
                    if (!r.visible && z.ignoreHiddenSeries)
                        t = false;
                    if (t) {
                        var J, E, Q, fa, ka, $;
                        if (!xa) {
            ...
            function da() {
                ...
                if (D) {
                    ...
                    for (t = 0; t < F.length; t++) {
                        ...
                        O[2];
                        if (F[t + 1])
                            if (Ta <= (S * aa[aa.length - 1] + F[t + 1][1]) / 2)
                                break
                    }
                    if (S === $ && Ta < 5 * S)
                        aa = [1, 2, 5];
                    ...
                    if (S >= Q)
                        aa.setSeconds(S >= fa ? 0 : F * lb(aa.getSeconds() / F));
                    if (S >= fa)
                        aa[Jd](S >= ka ? 0 : F * lb(aa[id]() / F));
                    if (S >= ka)
                        aa[Kd](S >= E ? 0 : F * lb(aa[jd]() / F));
                    if (S >= E)
                        aa[ld](S >= r ? 1 : F * lb(aa[Cc]() / F));
                    if (S >= r) {
            ...
            function Ma() {
                ...
                if (!xa)
                    for (k in s)
                        for (n in s[k])
                            s[k][n].cum = s[k][n].total;
                if (!I.isDirty)
                    I.isDirty = ia !== Dc || ra !== Sd
            }
            function za(k) {
                k = (new w(k)).render();
                Pb.push(k);
            ...
            function eb() {
                ...
                if (n && n.enabled) {
                    ...
                    n = I.stackTotalGroup;
                    if (!n)
                        I.stackTotalGroup = n = ga.g("stack-labels").attr({
                            visibility: Ab,
                            zIndex: 6
                        }).translate(X, ea).add();
                    for (fa in s) {
            ...
            function ab(k) {
                for (var n = Pb.length; n--;)
                    Pb[n].id === k && Pb[n].destroy()
            }
            ...
            q.prototype = {
                addLabel: function() {
                    ...
                    r = r && {
                        width: Ia(1, W(r - 2 * (n.padding || 10))) + Ua
                    };
                    r = sa(r, n.style);
                    if (E === Wa)
                        this.label = K(k) && t && n.enabled ? ga.text(k, 0, 0, n.useHTML).attr({
                            align: n.align,
                            rotation: n.rotation
                        }).css(r).add(na) : null;
                    else 
            ...
            w.prototype = {
                render: function() {
                    ...
                    if (t && K(t.text) && O && O.length && Da > 0 && Aa > 0) {
                        ...
                        if (!r)
                            k.label = r = ga.text(t.text, 0, 0).attr({
                        ...
                        r.align(t, false, {
                            x: S,
                            y: aa,
                            width: Ia.apply(Fa, ka) - S,
                            height: Ia.apply(Fa, O) - aa
                        });
                        r.show()
                    } else 
                        r && r.hide();
            ...
            x.prototype = {
                ...
                render: function(k) {
                    ...
                    if (this.label)
                        ...
                        this.label = l.renderer.text(n, 0, 0).css(this.options.style).attr({
                ...
                setOffset: function(k, n) {
                    ...
                    t = {
                        x: va ? t ? r: r - J: E,
                        y: va ? Q - E - n: t ? Q - r - J: Q - r,
                        width: va ?
                        J: n,
                        height: va ? n: J
                    };
                    this.label && this.label.align(this.alignOptions, null, t).attr({
                        visibility: Ab
                    })
                }
            };
            ...
            sa(I, {
                ...
                destroy: function() {
                    ...
                    if (I.stackTotalGroup)
                        I.stackTotalGroup = I.stackTotalGroup.destroy();
        ...
        function e(p) {
            ...
            Ma.padding = 0;
            var o = ga.g("tooltip").attr({
                zIndex: 8
            }).add(),
            I = ga.rect(ab, ab, 0, 0, p.borderRadius, N).attr({
                fill: p.backgroundColor,
                "stroke-width": N
            }).add(o).shadow(p.shadow), ba = ga.text("", eb + ab, ja(Ma.fontSize) + eb + ab, p.useHTML).attr({
                zIndex: 1
            }).css(Ma).add(o);
            o.hide();
            return {
                ...
                refresh: function(B) {
                    ...
                    if (ya === false ||!la)
                        ...
                        I.attr({
                            width: Oa,
                            height: R,
                            stroke: p.borderColor || B.color || V.color || "#606060"
                        });
                        D = fe(Oa, R, X, ea, Da, Aa, {
                            x: D,
                            y: ca
                        });
                        w(W(D.x - ab), W(D.y - ab))
                        ...
                        for (D = ta.length; D--;) {
                            ...
                            if (ta[D] && ca) {
                                ...
                                if (da[D])
                                    ...
                                    la = {
                                        "stroke-width": ta[D].width || 1,
                                        stroke: ta[D].color || "#C0C0C0",
                                        zIndex: 2
                                    };
                                    if (ta[D].dashStyle)
        ...
        function f(p) {
            ...
            function w(L) {
                ...
                u(Va, function(o) {
                    ...
                    s[ba ? "xAxis": "yAxis"].push({
                        axis: o,
                        value: I((va?!ba : ba) ? L.chartX - X : Aa - L.chartY + ea, true)
                    })
                });
                return s
            }
            ...
            bd = function() {
                if (Ec) {
                    ...
                    l.trackerGroup = Ec = ga.g("tracker").attr({
                        zIndex: 9
                    }).add()
            };
            bd();
            ...
            (function() {
                ...
                var L = function(s) {
                    if (!(s && s.touches && s.touches.length > 1)) {
                        ...
                        Jb || (Jb = Fd(oa));
                        if (Kb && s.type === "touchstart")
                            if (Ga(s.target, "isTracker"))
                                l.runTrackerClick || s.preventDefault();
                            else 
                                !ke&&!ba && s.preventDefault();
                        if (ba) {
                            if (o < X)
                                o = X;
                            else if (o > X + Da)
                        ...
                        if (ud && s.type !== "touchstart") {
                            ...
                            if (hc && p.shared) {
                                ...
                                D = Ha.length;
                                for (ca = 0; ca < D; ca++)
                                    if (Ha[ca].visible && Ha[ca].tooltipPoints.length) {
                ...
                oa.onclick = function(s) {
                    ...
                    s.cancelBubble = true;
                    if (!Ma)
                        if (o && Ga(s.target, "isTracker")) {
                            var I = o.plotX, ba = o.plotY;
                            sa(o, {
                                pageX: Jb.left +
                                X + (va ? Da - ba : I),
                                pageY: Jb.top + ea + (va ? Aa - I : ba)
                            });
                            Pa(o.series, "click", sa(s, {
                                point: o
                            }));
            ...
            sa(this, {
                ...
                destroy: function() {
                    if (l.trackerGroup)
                        l.trackerGroup = Ec = l.trackerGroup.destroy();
                    pb(ua, "mousemove", N);
        ...
        function m(p, q) {
            ...
            u([["title", p, uc], ["subtitle", q, Ic]], function(w) {
                ...
                if (V && N)
                    V = V.destroy();
                if (w && w.text&&!V)
                    l[x] = ga.text(w.text, 0, 0, w.useHTML).attr({
                        align: w.align,
                        "class": "highcharts-" +
                        x,
                        zIndex: 1
        ...
        function v() {
            ...
            l.container = oa = hb(Tb, {
                className: "highcharts-container" + (z.className ? " " + z.className : ""),
                id: Wd
            }, sa({
                position: Xd,
                overflow: ob,
            ...
            if (Yd && oa.getBoundingClientRect) {
                p = function() {
                    ...
                    Ja(oa, {
                        left: - (q.left - ja(q.left)) + Ua,
                        top: - (q.top - ja(q.top)) + Ua
                    })
                };
                p();
                Qa(db, "resize", p);
        ...
        function Y() {
            ...
            if (!l.seriesGroup)
                l.seriesGroup = ga.g("series-group").attr({
                    zIndex: 3
                }).add();
            u(Ha, function(x) {
                x.translate();
            ...
            if (q.enabled&&!l.credits) {
                ...
                l.credits = ga.text(q.text, 0, 0).on("click", function() {
                    ...
                    zIndex: 8
                }).css(q.style).add().align(q.position)
            }
            bd();
            l.hasRendered = true;
            if (Zb) {
        ...
        function U() {
            if (!Lc && db == db.top && ua.readyState !== "complete")
                ua.attachEvent("onreadystatechange", function() {
        ...
        gb = z.spacingBottom, Lb = z.spacingLeft, Rb, uc, Ic, ea, Ib, vb, X, Xb, qb, Zb, oa, Wd, dd, Jc, $a, cb, qd, ad, wc, Kc, Ad, xc, l = this, ke = (M = z.events)&&!!M.click, Bd, gc, hc, ud, jc, Zd, Cd, Aa, Da, Yb, Ec, bd, Fc, $b, ac, Jb, sc = z.showAxes, cd = 0, Va = [], Ob, Ha = [], va, ga, rd, Vd, sd, vd, Gc, yd, zd, xd, td, $d, le = function() {
            ...
            function w() {
                u(za, function(G) {
                    ...
                    ha && Ja(ha, {
                        left: na.translateX + G.legendItemWidth + ha.x - 40 + Ua,
                        top: na.translateY + ha.y - 11 + Ua
                    })
                })
            }
            function x(G) {
                ...
                if (!pa) {
                    ...
                    if (!La && wa && wa.lineWidth) {
                        var Vb = {
                            "stroke-width": wa.lineWidth,
                            zIndex: 2
                        };
                        if (wa.dashStyle)
                            Vb.dashstyle = wa.dashStyle;
                        G.legendLine = ga.path([Za, - da - Ma,
                        0, Ka, - Ma, 0]).attr(Vb).add(qa)
                    }
                    if (La)
                        ha = ga.rect(na =- da - Ma, Ra =- 11, da, 12, 2).attr({
                            zIndex: 3
                        }).add(qa);
                    else if (wa && wa.marker && wa.marker.enabled)
                        ha = ga.symbol(G.symbol, na =- da / 2 - Ma, Ra =- 4, wa.marker.radius).attr({
                            zIndex: 3
                        }).add(qa);
                    if (ha) {
                        ha.xOff = na + zb%2 / 2;
            ...
            function V() {
                ...
                u(Hb, function(Ra) {
                    var La = Ra.options;
                    if (La.showInLegend)
                        za = za.concat(La.legendType === "point" ? Ra.data : Ra)
                });
        ...
        td = function(p) {
            ...
            !p || p.resetSelection ? u(Va, function(x) {
                ...
                "zoomY"])
                    V.setExtremes(x.min, x.max, false, w)
            });
            i()
        };
        Gc = function() {
            ...
            yd();
            if ((l.title || l.subtitle)&&!K(y))
                if (ta = Ia(l.title&&!uc.floating&&!uc.verticalAlign && uc.y || 0, l.subtitle&&!Ic.floating&&!Ic.verticalAlign && Ic.y || 0))
                    ea = Ia(ea, ta + A(uc.margin, 15) + Na);
            if (p.enabled&&!p.floating)
                if (V === "right")
                    K(C) || (Ib = Ia(Ib, $b - w + q + Ea));
                else if (V === "left")
                    K(Sa) || (X = Ia(X, $b + w + q + Lb));
                else if (N === "top")
                    K(y) || (ea = Ia(ea, ac + x + q + Na));
                else if (N === "bottom")
                    K(Z) ||
                    (vb = Ia(vb, ac - x + q + gb));
            sc && u(Va, function(da) {
        ...
        vd = function() {
            ...
            if (p || q)
                if (wc)
                    wc.animate(wc.crisp(null, null, null, $a - V, cb - V));
                else 
                    wc = ga.rect(V / 2, V / 2, $a - V, cb - V, z.borderRadius, p).attr({
            ...
            if (w)
                if (Kc)
                    ...
                    Kc = ga.rect(X, ea, Da, Aa, 0).attr({
                        fill: w
                    }).add().shadow(z.plotShadow);
            if (x)
                if (Ad)
                    Ad.animate(N);
                else 
                    Ad = ga.image(x, X, ea, Da, Aa).add();
            if (z.plotBorderWidth)
                if (xc)
                    xc.animate(xc.crisp(null, X, ea, Da, Aa));
                else 
                    xc = ga.rect(X, ea, Da, Aa, 0, z.plotBorderWidth).attr({
                        stroke: z.plotBorderColor,
                        "stroke-width": z.plotBorderWidth,
                        zIndex: 4
                    }).add();
            l.isDirtyBox = false
        };
    ...
    Nc = {
        init: function(a, b, c) {
            ...
            i, j = function(m) {
                for (g = m.length; g--;)
                    m[g] === Za && m.splice(g + 1, 0, m[g + 1], m[g + 2], m[g + 1], m[g + 2])
            };
            if (e) {
                j(b);
                j(c)
    ...
    var bc = function(a) {
        ...
        (function(d) {
            if (c = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/.exec(d))
                b = [ja(c[1]), ja(c[2]), ja(c[3]), parseFloat(c[4],
                10)];
            else if (c = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(d))
                b = [ja(c[1], 16), ja(c[2], 16), ja(c[3], 16), 1]
        })(a);
        return {
            get: function(d) {
            ...
            if (Sb(a)) {
                ...
                for (c in a) {
                    ...
                    if (c === "d") {
                        ...
                        if (this.rotation)
                            Ga(g, "transform", "rotate(" + this.rotation + " " + d + " " + ja(a.y || Ga(g, "y")) + ")")
                        } else if (c === "fill")
                            d = i.color(d, g, c);
                                            ...
                                            if (c === "text") {
                                                ...
                                                if (v && (c === "x" || c === "y" || c === "translateX" || c === "translateY" || c === "visibility")) {
                                                    ...
                                                    for (Y = 0; Y < f; Y++) {
                                                        ...
                                                        v = v.htmlNode;
                                                        Ja(v, sa(this.styles, {
                                                            left: j.x + (this.translateX || 0) + Ua,
                                                            top: j.y + (this.translateY || 0) + Ua
                                                        }));
                                                        c === "visibility" && Ja(v, {
                                                            visibility: d
                                                        })
    ...
    ed.prototype = {
        ...
        buildText: function(a) {
            ...
            if (i) {
                if (!j)
                    j = a.htmlNode = hb("span", null, sa(h, {
                        position: ic,
                        top: 0,
                        left: 0
                    }), this.box.parentNode);
        ...
        c, d) {
            var e = vc + wd++, f = this.createElement("clipPath").attr({
                id: e
            }).add(this.defs);
                    ...
                    if (b.tagName === "SPAN") {
                        ...
                        if (U !== a.cTT) {
                            if (K(c)) {
                                ...
                                P = Cb(j);
                                Ja(b, {
                                    filter: c ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", d, ", M12=", - P, ", M21=", P, ", M22=", d, ", sizingMethod='auto expand')"].join(""): jb
                                })
                            }
                            j = b.offsetWidth;
                            m = b.offsetHeight;
            ...
            clipRect: function(a, b, c, d) {
                ...
                return sa(e, {
                    ...
                    getCSS: function(f) {
                        ...
                        g = {
                            clip: "rect(" + W(f ? h : g) + "px," + W(f ? j : i) + "px," + W(f ? i : j) + "px," + W(f ? g : h) + "px)"
                        };
                        !f && Mc && sa(g, {
                            width: i + Ua,
                            height: j + Ua
    ...
    Oc.prototype = {
        ...
        setState: function(a) {
            ...
            if (!(a === this.state || this.selected && a !== "select" || c[a] && c[a].enabled === false || a && (f || e&&!d.enabled))) {
                if (this.graphic)
                    this.graphic.attr(i[a]);
                else {
                    if (a) {
                        if (!g)
                            b.stateMarkerGraphic = g = h.renderer.circle(0,
    ...
    sb.prototype = {
        ...
        cleanData: function() {
            ...
            if (this.options.connectNulls)
                for (g =
                b.length - 1; g >= 0; g--)
                    b[g].y === null && b[g - 1] && b[g + 1] && b.splice(g, 1);
        ...
        setTooltipPoints: function(a) {
            ...
            u(d, function(i, j) {
                ...
                for (g = i._high = d[j + 1] ? lb((i.plotX + (d[j + 1] ? d[j + 1].plotX : e)) / 2) : e; f <= g;)
                    h[c ? e - f++: f++] = i
            });
                ...
                for (f = b.length; f--;) {
                    ...
                    if (e !== Wa&&!isNaN(e)) {
                        ...
                        if (i)
                            ...
                            g.graphic = c.renderer.symbol(A(g.marker && g.marker.symbol, this.symbol), d, e, h).attr(a).add(this.group)
                        }
                }
            },
        ...
        getAttribs: function() {
            ...
            if (a.options.marker) {
                ...
                d.color = d.color || bc(d.color || f).brighten(d.brightness).get();
            ...
            for (f = h.length; f--;) {
                ...
                if (e) {
                    ...
                    e = c[Bb] = c[Bb] || {};
                    if (!a.options.marker)
                        e.color = bc(e.color || g.options.color).brighten(e.brightness || d.brightness).get();
        ...
        drawDataLabels: function() {
            if (this.options.dataLabels.enabled) {
                ...
                if (g)
                    g.translate(h.plotLeft, h.plotTop);
                else 
                    g = this.dataLabelsGroup = i.g("data-labels").attr({
                ...
                u(c, function(H) {
                    ...
                    if (y) {
                        if (j&&!e.y)
                            b = b + ja(y.styles.lineHeight) * 0.9 - y.getBBox().height / 2;
                        y.attr({
                            text: f
                        }).animate({
                            x: a,
                        ...
                        y =
                        H.dataLabel = i.text(f, a, b).attr({
                            align: C,
                            rotation: e.rotation,
                            zIndex: 1
                        }).css(e.style).add(g);
                        j&&!e.y && y.attr({
                            y: b + ja(y.styles.lineHeight) * 0.9 - y.getBBox().height / 2
                        })
                    }
                    if (P && d.stacking && y) {
                        z = H.barY;
        ...
        drawGraph: function() {
            ...
            u(a.segments, function(U) {
                ...
                u(U, function(C, Z) {
                    if (a.getPointSpline)
                        m.push.apply(m, a.getPointSpline(U, C, Z));
                    else {
                        m.push(Z ? Ka : Za);
                ...
                if (T) {
                    ...
                    if (b.stacking && a.type !== "areaspline")
                        for (M = U.length - 1; M >= 0; M--)
                            z.push(U[M].plotX, U[M].yBottom);
                    else 
                        z.push(Ka, U[U.length - 1].plotX, P, Ka, U[0].plotX, P);
                    H = H.concat(z)
                }
            });
            a.graphPath = d;
            ...
            if (T) {
                ...
                if (f)
                    ...
                    a.area = a.chart.renderer.path(H).attr({
                        fill: e
                    }).add(g)
            }
            if (c) {
        ...
        setVisible: function(a, b) {
            ...
            this.options.stacking && u(c.series, function(m) {
                if (m.options.stacking && m.visible)
                    m.isDirty = true
            });
            if (j)
                c.isDirtyBox = true;
    ...
    var hd = yb(sb, {
        ...
        translate: function() {
            ...
            u(v, function(C) {
                ...
                C.shapeArgs = Z;
                C.trackerArgs = K(Rb) && Ca(C.shapeArgs, {
                    height: Ia(6, gb + 3),
                    y: Rb
                })
            })
            ...
            u(a.data, function(f) {
                ...
                if (g !== Wa&&!isNaN(g) && f.y !== null) {
                    ...
                    if (d) {
                        ...
                        f.graphic = c[f.shapeType](e).attr(f.pointAttr[f.selected ? "select": ib]).add(a.group).shadow(b.shadow)
                }
            })
        },
        drawTracker: function() {
            var a =
            this, b = a.chart, c = b.renderer, d, e, f =+ new Date, g = a.options, h = g.cursor, i = h && {
                cursor: h
            }, j;
            u(a.data, function(m) {
                e = m.tracker;
                ...
                if (m.y !== null)
                    if (e)
                        ...
                        m.tracker = c[m.shapeType](d).attr({
                            isTracker: f,
                            fill: ce,
                            visibility: a.visible ? Ab: ob,
                            zIndex: g.zIndex || 1
    ...
    ma = yb(sb, {
        ...
        drawPoints: function() {
            ...
            u(this.data, function(i) {
                ...
                if (d)
                    ...
                    i.graphic = b.arc(h).attr(sa(i.pointAttr[ib], {
        ...
        drawDataLabels: function() {
            ...
            if (d.enabled) {
                ...
                u(a, function(gb) {
                    if (gb.dataLabel)
                        T[gb.labelPos[7] < kc / 2 ? 0: 1].push(gb)
                });
                T[1].reverse();
                z = function(gb, Lb) {
                    return Lb.y - gb.y
                ...
                for (a = T[0][0] && T[0][0].dataLabel && ja(T[0][0].dataLabel.styles.lineHeight); M--;) {
                    ...
                    for (y = 0; y < Na; y++) {
                        ...
                        Ea = H.i;
                        H = H.y;
                        if (Y > H && C[Ea + 1] !== null || Y < H && C[Ea - 1] !== null)
                            H = Y;
