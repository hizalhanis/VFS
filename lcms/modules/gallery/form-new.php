	<div class="lcms-gallery-new lcms-control-form">
		<div>
		...
		<button class="lcms-dbtn lcms-gallery-save">Save</button>	
		<button class="lcms-dbtn lcms-gallery-save-publish">Save &amp; Publish</button>	
		<button class="lcms-dbtn lcms-gallery-discard">Discard</button>	
	</div>