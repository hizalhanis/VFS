	<div class="lcms-slideshow-new lcms-control-form">
		<div>
		...
		<button class="lcms-dbtn lcms-slideshow-save">Save</button>	
		<button class="lcms-dbtn lcms-slideshow-save-publish">Save &amp; Publish</button>	
		<button class="lcms-dbtn lcms-slideshow-discard">Discard</button>	
	</div>